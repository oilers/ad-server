...
class AuctionServiceSpec extends Specification{
    ...
    def "When an auction is performed there is a winner and it is recorded"(){
        ...
        AuctionParamaters paramaters = new AuctionParamaters(width: 100, height: 100, userId: 1, userAgent: "Spock Test", domain: "unittest.com", ip: "444.444.444.444", transactionId: uuid)
        when:
